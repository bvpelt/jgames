...
export class Player {
    ...
    constructor(game: Game, context: any) {
        ...
        this.states = [new Sitting(this.game), new Sitting(this.game),new Sitting(this.game),new Sitting(this.game),new Sitting(this.game),new Sitting(this.game),new Sitting(this.game) ]; 
