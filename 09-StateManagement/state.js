...
export class StandingLeft extends State {
    ...
    handleInput(input) {
        ...
        else if (input == PRESS_UP) this.player.setState(states.JUMPING_LEFT);
    }
}
...
export class StandingRight extends State {
    ...
    handleInput(input) {
        ...
        else if (input == PRESS_UP) this.player.setState(states.JUMPING_RIGHT);
    }
}
...
export class JumpingLeft extends State {
    ...
    handleInput(input) {
        if (input === PRESS_RIGHT) this.player.setState(states.JUMPING_RIGHT);
...
export class JumpingRight extends State {
    ...
    handleInput(input) {
        if (input === PRESS_LEFT) this.player.setState(states.JUMPING_LEFT);
...
export class FallingLeft extends State {
    ...
    handleInput(input) {
        if (input === PRESS_RIGHT) this.player.setState(states.FALLING_RIGHT);
        else if (this.player.onGround()) this.player.setState(states.STANDING_RIGHT);
    }
}
...
export class FallingRight extends State {
    ...
    handleInput(input) {
        if (input === PRESS_LEFT) this.player.setState(states.FALLING_LEFT);
        else if (this.player.onGround()) this.player.setState(states.STANDING_RIGHT);
    }
}